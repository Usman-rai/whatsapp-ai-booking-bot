...
n8n Gemini WhatsApp Airtable Google Calendar License

🎬 Live Demo
Watch the bot book a real appointment in under 60 seconds:

▶️ Demo Video — Automated Appointment Booking

Live demo website:

🌐 BrightSmile Dental Melbourne — click the WhatsApp button
...
Full system prompt: prompts/ai-receptionist-system-prompt.md
...
Duplicate the n8n workflow
Create new Airtable base with the schema above
Update the system prompt with clinic-specific info:
Clinic name, address, phone
Opening hours
Services and prices
Insurance accepted
Connect client's Google Calendar
Set up client's Twilio or Meta WhatsApp number
...
Have a dental or healthcare clinic in Australia? Get in touch — I'll set this up for you in 3 days.
